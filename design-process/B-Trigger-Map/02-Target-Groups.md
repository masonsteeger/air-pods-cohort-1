# Target Groups: air-pods-cohort-1

> Prioritized target groups with detailed personas and driving forces
...
## Priority 1: Prospective Pete (Pete the Prospect) — External Community Member

### Who Pete Is

Pete is a mid-career software developer in the DFW area who attends 1-2 meetups a month when he knows about them. He moved to Dallas 18 months ago from Austin and lost his established meetup network. He's heard Improving hosts groups but has no idea which ones, when, or how to find them.

### Psychological Profile

Pete values **continuous learning and professional community** — he knows his career grows faster when he's plugged into local tech circles. He's not passive; he actively searches for groups, but his discovery tools are fragmented. He checks Meetup.com by topic, scans LinkedIn posts, and asks colleagues. The friction isn't motivation — it's **visibility**. He'd attend more events if he could find them.

Pete is **pragmatic about his time**. He won't spend 20 minutes hunting across five Meetup pages to piece together a schedule. He wants a single view: what's happening, when, where, is it relevant to me? If that view doesn't exist, he defaults to the 2-3 groups he already knows and misses everything else.

He has a mild **fear of showing up to the wrong thing** — walking into a room where the topic is way outside his expertise or the group culture doesn't fit. Seeing group descriptions, average attendance, and topic areas in advance reduces this anxiety.

### Internal State

When Pete thinks about finding new meetups, he feels **mildly frustrated and resigned**. He knows there's more out there but doesn't have a good way to find it. When he discovers a new relevant group, he feels a spark of **excitement and connection** — "this is exactly what I was looking for."

### Usage Context

Pete finds the calendar via Google search ("tech meetups Dallas"), a colleague's link, or Improving's website. He's scanning for **relevance and logistics**: What topics? What night? Where exactly? He scans quickly — if the page loads slowly or looks outdated, he bounces. If he sees a well-organized list with dates, topics, and Meetup links, he opens 2-3 groups in new tabs and RSVPs within minutes. The calendar's job is to get him from "browsing" to "RSVP" in under 60 seconds.

### Relationship to Business Goals

- ✅ **Maximize Community Visibility:** Pete IS the visibility goal — every new Pete who discovers the calendar validates Improving's investment
- ✅ **Increase Event Attendance:** Pete converts directly to attendance; removing his discovery barrier is the highest-leverage action
- ✅ **Reduce Operational Friction:** Pete currently emails Dawn or asks colleagues; the calendar eliminates these inquiries

### Positive Driving Forces

1. **Discover all relevant DFW tech groups in one place** — stop piecing together fragmented Meetup searches (Frequency: 5, Intensity: 4, Fit: 5 = **14 HIGH**)
2. **Quickly assess if a group is worth attending** — see topic, size, frequency before committing time (Frequency: 5, Intensity: 3, Fit: 5 = **13 MEDIUM**)
3. **Build a broader local professional network** — meet people outside his immediate work bubble (Frequency: 3, Intensity: 4, Fit: 3 = **10 LOW**)
4. **Have a bookmarkable link to check monthly** — one stable URL replaces scattered searching (Frequency: 4, Intensity: 3, Fit: 5 = **12 MEDIUM**)

### Negative Driving Forces

1. **Fear of missing events he'd love** — knowing they happened after the fact is deeply frustrating (Frequency: 4, Intensity: 5, Fit: 5 = **14 HIGH**)
2. **Frustration with fragmented discovery** — checking 5 different Meetup pages is tedious and incomplete (Frequency: 5, Intensity: 4, Fit: 5 = **14 HIGH**)
3. **Anxiety about showing up unprepared** — walking into an unfamiliar group without knowing what to expect (Frequency: 3, Intensity: 3, Fit: 4 = **10 LOW**)
...
Harold is a mid-level developer at Improving who volunteered to be an event host for user group nights. He's the face of Improving when external attendees walk through the door — he greets them, makes sure they're comfortable, points them to food, and represents the company in a warm, approachable way. He coordinates directly with organizers like Oscar on event night and works with Dawn on logistics beforehand. He's been at Improving for three years and genuinely loves the people side of tech.

### Psychological Profile

Harold is a **natural connector** who volunteered for hosting because it aligns with who he already is. Nobody assigned him this role; he sought it out because Improving's community values match his own. He's a **soft brand ambassador** who takes pride in making visitors feel that Improving is a special place. He loves handing out company swag — it's a natural conversation starter that makes visitors feel welcomed.

Underneath the warmth, Harold has a **strategic instinct**. He listens for signals: a visitor mentions they're job hunting, a startup founder complains about scaling challenges. Harold doesn't hard-sell — he connects. "You should talk to our data team." He sees every event as a chance to **expand Improving's network organically**.

Harold is distinct from Imani in a key way: Imani is a **consumer** of the community (she wants to attend and learn), while Harold is a **facilitator** (he wants to make events successful and connect people to Improving).

### Internal State

When Harold thinks about hosting, he feels **energized and purposeful**. It's the part of his week that doesn't feel like work. He takes **personal pride** when an event goes smoothly — good turnout, visitors engaged, organizer happy. When attendance is low or a visitor seems lost, he feels **responsible**, like he could have done more.

### Usage Context

Harold checks the calendar early in the week to see what's coming up. He needs to know: Which group is meeting? How many typically attend? Who's the organizer? This lets him prepare — enough food, right room configuration, mentally gear up. On event night, he shares the calendar link with visitors: "Check this out — we host 20 groups here. Come back anytime."

### Relationship to Business Goals

- ✅ **Maximize Community Visibility:** Harold is the human embodiment of visibility — every visitor he greets learns about Improving firsthand
- ✅ **Increase Event Attendance:** Harold's warm welcome encourages repeat attendance; he's the reason one-time visitors become regulars
- ✅ **Reduce Operational Friction:** The calendar gives Harold self-serve information so he doesn't need to ask Dawn "what's this week?"

### Positive Driving Forces

1. **Know what events he's hosting this week so he can prepare properly** — room setup, food, expectations (Frequency: 5, Intensity: 4, Fit: 5 = **14 HIGH**)
2. **Connect visitors with Improving's people and offerings naturally** — soft ambassador role (Frequency: 4, Intensity: 4, Fit: 3 = **11 MEDIUM**)
3. **Share a professional link that showcases Improving's full community portfolio** — hand visitors something tangible (Frequency: 3, Intensity: 3, Fit: 5 = **11 MEDIUM**)
4. **Represent Improving's community values and make visitors feel welcome** — swag, warmth, connection (Frequency: 4, Intensity: 5, Fit: 2 = **11 MEDIUM**)

### Negative Driving Forces

1. **Being unprepared for an event** — wrong room, not enough food, wrong expectations (Frequency: 3, Intensity: 5, Fit: 5 = **13 MEDIUM**)
2. **Low attendance reflecting poorly on Improving's community investment** — empty room feels like failure (Frequency: 3, Intensity: 4, Fit: 3 = **10 LOW**)
